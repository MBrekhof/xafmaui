...
using System.Text;
using XafMaui.Blazor.Server.Services;
using XafMaui.WebApi.JWT;

namespace XafMaui.Blazor.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                builder.UseApplication<XafMauiBlazorApplication>();
                ...
                builder.Modules
                    ...
                    .AddViewVariants()
                    .Add<XafMaui.Module.XafMauiModule>()
                    .Add<XafMauiBlazorModule>();
                builder.ObjectSpaceProviders
                    .AddSecuredEFCore(options =>
                    {
                        options.PreFetchReferenceProperties();
                    })
                    .WithDbContext<XafMaui.Module.BusinessObjects.XafMauiEFCoreDbContext>((serviceProvider, options) =>
                    {
                ...
                builder.Security
                    .UseIntegratedMode(options =>
                    {
                        ...
                        options.UserType = typeof(XafMaui.Module.BusinessObjects.ApplicationUser);
                        // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                        // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                        options.UserLoginInfoType = typeof(XafMaui.Module.BusinessObjects.ApplicationUserLoginInfo);
